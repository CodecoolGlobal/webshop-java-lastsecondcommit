...
VALUES ('Bunch of smol Cacti', 'Stellar collection of little cacti. If you take good care of them, they protect you from ' ||
 'robbers and bad men by throwing themselves on the floor before thus immobilizing the intruder.', 100, 'USD', 'cactus', 2, 1),
 ('Highfive Cactus', 'Big Brother cactus. He watches your daily life and comforts you when in need.', 20, 'USD', 'cactus', 2, 1),
 ('Spikealousless Cactus', 'Smol cactus', 10, 'USD', 'cactus', 2, 1),
 ('Spikasaurus Rex', 'Pack of StoneRose. They are siblings to cacti.', 30, 'USD', 'cactus', 2, 1),
 ('Candelabra Cactus', 'Piercing cactus', 5, 'USD', 'cactus', 2, 1),
 ('Josephs Coat', 'Bonsai cactus. Bedroom size version of his successor who lives in the Atacama Desert.', 25, 'USD', 'cactus', 2, 1),
 ('Mandarin Cactus', 'Pair of mandarin cacti. They together almost make an orange.', 20, 'USD', 'cactus', 2, 1),
 ('Pink Mr. Lincoln', 'Pink rose.', 5, 'USD', 'flower', 1, 2),
 ('Colourful bunch Daisies', 'Spring flower.', 15, 'USD', 'flower', 1, 2),
 ('Red Pat Austin', 'Red rose. Even Zorro would be jealous.', 10, 'USD', 'flower', 1, 2),
 ('Pink Leucadendron', 'Purple?', 10, 'USD', 'flower', 1, 2),
 ('Yellow Daffodil', 'Yellow flower!', 10, 'USD', 'flower', 1, 2),
 ('White Lily', 'Snow White.', 5, 'USD', 'flower', 1, 2),
 ('Pink Cinquefoil', 'Three head flower. If you ever try to cut one head off, it will grow back three instead! But only ' ||
  'after it cuts your hair.', 20, 'USD', 'flower', 1, 2),
 ('Green Leaflet', 'The greenest of them all', 15, 'USD', 'littlePlant', 3, 3),
 ('Home Plant', 'This is the best choice if you, like most people forgets to water the plant time to time. It can live for a ' ||
  'month without watering!', 15, 'USD', 'littlePlant', 3, 3),
 ('Elephant Grass', 'Very nice for a bedroom.', 20, 'USD', 'littlePlant', 3, 3),
 ('Monstera', 'Leaves so big you could place in on a balcony and it casts shadows all over the place.', 35, 'USD', 'littlePlant', 3, 3),
 ('Piercy Growling', 'It may seem small now but will grow big and fierce.', 10, 'USD', 'littlePlant', 3, 3),
 ('ZZ Plant', 'A piece of forest for your home', 15, 'USD', 'littlePlant', 3, 3),
 ('Pothos', 'It spreads like gossip.', 25, 'USD', 'littlePlant', 3, 3),
 ('Lady Palm', 'Spectacular plant.', 45, 'USD', 'palm', 3, 4),
 ('Parlor Palm', 'Best to place in spacious areas, it fills the room.', 40, 'USD', 'palm', 3, 4),
 ('Florida Silver Palm', 'Palm tree from India.', 30, 'USD', 'palm', 3, 4),
 ('Yucca', 'No big leaves but rather strong trunk.', 20, 'USD', 'palm', 3, 4),
 ('Dracaenat', 'You may recognize it from cartoon network shows. It was often used as the hair of many iconic characters.',
 25, 'USD', 'palm', 3, 4),
 ('Pygmy Date Palm', 'Maugli envies you if your choice fall upon thee.', 120, 'USD', 'palm', 3, 4),
 ('Ficus', 'The crown of Caesar.', 35, 'USD', 'palm', 3, 4),